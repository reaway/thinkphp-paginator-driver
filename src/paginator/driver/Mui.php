...
class Mui extends Paginator
{
    ...
    public function render()
    {
        if ($this->hasPages()) {
            if ($this->simple) {
                return sprintf(
                    '<ul class="mui-pager">%s %s</ul>',
                    $this->getPreviousButton(),
                    $this->getNextButton()
                );
            } else {
                return sprintf(
                    '<ul class="mui-pagination">%s %s %s</ul>',
                    $this->getPreviousButton(),
                    $this->getLinks(),
                    $this->getNextButton()
                );
    ...
    {
        return '<li class="mui-disabled"><span>' . $text . '</span></li>';
    }
    ...
    {
        return '<li class="mui-active"><span>' . $text . '</span></li>';
    }
